...
{
public:
	// Format SN payload (64 bytes) given meto(4 bytes), timeStr (WCHAR[9] null-terminated, YYYYMMDD), psn (WCHAR up to 8 chars)
	static std::array<BYTE, 64> FormatSnData(const char meto[4], const WCHAR* timeStr, const WCHAR* psn);
